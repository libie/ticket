...
function HS_setDate(inputObj){
  ...
  <%
  	...
  	int nowPage;
  	Object nowpagestr = request.getAttribute("nowPage");
  	if(nowpagestr==null){
  		nowPage=1;
  	}else{
  		String nowpagetemp = (String)request.getAttribute("nowPage");
    ...
    <div>
    	<form action="SearchCustomByDate?nowpage=1" method="post" name="myform">
    		<table  border="1" bordercolor="black" style=" width: 800px; border: none ;">
    			<tr  bgcolor="#BDBDBD">
		  			<td>开始日期：</td>
		  			<td><input type="text" onfocus="HS_setDate(this)" name="sdate" style="width: 100px" value=""/></td>
		  			<td>到</td>
		  			<td>结束日期：</td>
		  			<td><input type="text" onfocus="HS_setDate(this)" name="edate" style="width: 100px" width="70" value=""/></td>
		  			<td>&nbsp;</td>
		  			<td>&nbsp;</td>
    			...
    			<tr bgcolor="#BDBDBD">
		  		...
		  		<tr <c:if test="${status.index%2==0 }"> bgcolor="#90EE90"</c:if>>
		  		...
		  		<tr align="center">
		  			...
		  			function bakward(){
			  			if(<%=nowPage%>==1)
				  			return;
			  			document.myform.action='SearchCustomByDate?page=<%=nowPage-1 %>';

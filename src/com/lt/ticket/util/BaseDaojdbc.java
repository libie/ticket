...
//	public final static String URL = "jdbc:sqlserver://192.168.73.44:39947;databaseName=ticket"; // url
//	public final static String DBNAME = "sa"; // 数据库用户名
//	public final static String DBPASS = "ZXKJ"; // 数据库密码
...
//	public final static String DBPASS = ""; // 数据库密码
	...
	public final static String DBNAME = "lzh"; // 数据库用户名
	public final static String DBPASS = "lzh"; // 数据库密码

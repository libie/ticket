...
public class Search extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//与数据库交互,得到数据
		zongjine = td.getFenLeiZongJinE(jinefenlei, myconn);
		zongpiaoshu = td.getFenLeiPiaoShu(piaoshufenlei, myconn);
		...
		//request.getSession().setAttribute("kuan", kuan);
		//request.getSession().setAttribute("piao", piao);
		//request.getSession().setAttribute("kuanfenlei", kuanfenlei);
		//request.getSession().setAttribute("piaofenlei", piaofenlei);
